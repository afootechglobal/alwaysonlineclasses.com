...
<title> Government | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/government"><li>Government</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Government</span></h1>
			<p>Government refers to the system or group of individuals responsible for governing and managing a political entity, such as a country, state, or local community. </p>
		</div>		
    </div>
					...
					<div class="faq-back-div  main-topics-back-div" data-aos="fade-up" data-aos-duration="900">
						<div class="faq-text-div main-faq-text-div ">
							...
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									<div class="faq-title-text">
										<h2>POLITICAL DEVELOPMENT IN NIGERIA</h2>
									</div>
							...
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									<div class="faq-title-text">
										<h2>NIGERIA AND THE INTERNATIONAL COMMUNITY</h2>
									</div>
