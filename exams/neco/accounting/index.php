...
<title> Accounting | <?php echo $thename?></title>
		...
		<div class="top-title-div">
			<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/accounting"><li>Accounting</li></a>
				</ul>
			</div>			
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Accounting</span></h1>
			<p>Accounting is a systematic process of recording, analyzing, summarizing, and interpreting financial transactions and information of an individual, organization, or entity. </p>
		</div>		
    </div>
						...
						<div class="faq-text-div main-faq-text-div ">
							...
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									...
									<div class="faq-answer-div faq-answer-display" id="faq245answer" style="display: none;"> 
