    ...
    <div class="page-content-div sb-container">
        <div class="content-side-div">
             <div class="div-in">
                ...
                <div class="video-div">
                    <!-- <iframe src="<?php// echo $website_url?>/uploaded_files/videos/n-bases.mp4" frameborder="0" ></iframe>   -->
                    <video controls="">					
        ...
        <div class="content-side-div content-right-div">
             <div class="div-in"> 
                    <div class="related-details">
                        
                      <div class="title"> RELATED VOLUMES </div> 
                        <br clear="all"/>
                        <div class="list-div " id="">
                            ...
                            <div class="text-div">
                                <h2>Number Base</h2> 
                                <div class="text-in">
                                    <div class="text">Volume <span>Volume 1</span></div>
                                </div>
                            <br>
                            </div>
                        </div>
                        ...
                        <div class="list-div " id="">
                            <div class="img-div"><img src="<?php echo $website_url?>/all-images/body-pix/fraction.jpg" alt="fraction"/></div>
                            <div class="text-div">
                                <h2>Fraction, decimals, appromximations and percentages</h2> 
                                <div class="text-in">
                                    <div class="text">Volume <span>Volume 2</span></div>
                                </div>
                            <br>
                            </div>
                        </div>
