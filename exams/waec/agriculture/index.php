...
<title> Agriculture | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/agriculture"><li>Agriculture</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Agriculture</span></h1>
			<p>Agriculture is the practice of cultivating plants, raising animals, and producing food, fiber, and other agricultural products for human consumption and use.</p>
		</div>		
    </div>
					...
					<div class="faq-back-div  main-topics-back-div" data-aos="fade-up" data-aos-duration="900">
						<div class="faq-text-div main-faq-text-div ">
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									<div class="faq-title-text">
										<h2>GENERAL AGRICULTURE & AGRONOMY</h2>
									</div>
							...
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									<div class="faq-title-text">
										<h2>ANIMAL PRODUCTION, AGRIC ECONOMIC & EXTENSION AGRICULTURAL TECHNOLOGY</h2>
									</div>
