...
<title> Biology | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/biology"><li>Biology</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Biology</span></h1>
			<p>Biology is the scientific study of living organisms, including their structure, function, growth, evolution, and interactions with their environment.</p>
		</div>		
    </div>
							...
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									<div class="faq-title-text">
										<h2>STRUCTURAL/BEHAVIOURAL ADAPTATION OF VERTEBRATES VARIETY OF ORGANISMS</h2>
									</div>
