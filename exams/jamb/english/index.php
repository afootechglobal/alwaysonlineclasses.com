...
<title> Use Of English | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/english"><li>Use Of English</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Use Of English</span></h1>
			<p>An English summary refers to a concise and condensed version of a text or document written in the English language. .</p>
		</div>		
    </div>
