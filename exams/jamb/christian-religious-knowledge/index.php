...
<title> Christian Religious Knowledge | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/christian-religious-knowledge"><li>Christian Religious Knowledge</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Christian Religious Knowledge</span></h1>
			<p>Christian Religious Knowledge (CRK) is a subject that explores the beliefs, teachings, practices, and history of Christianity.</p>
		</div>		
    </div>
            ...
            <div class="search-text-div" data-aos="zoom-in" data-aos-duration="800">
                <div class="search-segment-div">
                    <select id="cat_id" class="text_field">
                        ...
                        <option value="">COMPREHENSION AND SUMMARY</option>
					...
					<div class="faq-back-div  main-topics-back-div" data-aos="fade-up" data-aos-duration="900">
						<div class="faq-text-div main-faq-text-div ">
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									<div class="faq-title-text">
										<h2>THEMES TO THE CREATION TO THE DIVISION OF THE KINGDOM</h2>
									</div>
									
									<div class="faq-answer-div faq-answer-display topics-answer-div" onclick="_collapse('faq243')">
										<p>Sub-Topics  <i class="bi-chevron-down"></i> <span class="count">20</span></p> 
									...
									<div class="faq-answer-div faq-answer-display" id="faq243answer" style="display: none;">  
										<div class="topics-content-div">
											<div class="image-div">
												<img src="<?php echo $website_url?>/all-images/body-pix/lexis.jpg" alt="lexis"/>
											</div>

											<div class="text">
												<h3>Lexis and Structure</h3>
												<p>A "lexis and structure" summary refers to a concise overview of the vocabulary and grammatical structure used in a text or language...</p>
										...
										<div class="topics-content-div">
											<div class="image-div">
												<img src="<?php echo $website_url?>/all-images/body-pix/synonyms.jpg" alt="synonyms"/>
											</div>

											<div class="text">
												<h3>Synonyms</h3>
												<p>A synonyms summary refers to a brief overview or compilation of synonyms, which are words that have similar meanings to other words...</p>
												<a href="<?php echo $website_url ?>/#" title="Number Bases">
												<button class="topics-btn" title="Play Video">Play Video </button></a>
											</div>
										</div>															
							...
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									<div class="faq-title-text">
										<h2>THEMES FROM THE DIVISION OF THE KINGDOM TO THE RETURN FROM EXILE AND THE PROPHETS</h2>
									</div>
									
									<div class="faq-answer-div faq-answer-display topics-answer-div" onclick="_collapse('faq244')">
										<p>Sub-Topics <i class="bi-chevron-down"></i> <span class="count">51</span></p> 
									...
									<div class="faq-answer-div faq-answer-display" id="faq244answer" style="display: none;">  
										...
										<div class="topics-content-div">
											<div class="image-div">
												<img src="<?php echo $website_url?>/all-images/body-pix/intonation.webp" alt="geometry"/>
											</div>

											<div class="text">
												<h3>Intonation</h3>
												<p>Intonation refers to the melodic patterns, pitch variations, and rhythmic elements used in spoken language to convey meaning, express emotions, and signal linguistic features. </p>
												<a href="<?php echo $website_url ?>/#" title="Number Bases">
												<button class="topics-btn" title="Play Video">Play Video </button></a>
											</div>
										</div>
										...
										<div class="topics-content-div">
											<div class="image-div">
												<img src="<?php echo $website_url?>/all-images/body-pix/rhyme.jpg" alt="rhyme"/>
											</div>

											<div class="text">
												<h3>Rhymes</h3>
												<p>A rhymes summary provides a concise overview of the concept of rhyming in language and its role in poetry, songwriting, and other forms of creative expression.....</p>
												<a href="<?php echo $website_url ?>/#" title="Number Bases">
												<button class="topics-btn" title="Play Video">Play Video </button></a>
											</div>
										</div>
