...
<title> Geography | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/geography"><li>Geography</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Geography</span></h1>
			<p>Geography is the study of the Earth's physical features, climate, natural resources, human populations, and their interactions.</p>
		</div>		
    </div>
