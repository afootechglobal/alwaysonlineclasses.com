...
<title> Chemistry | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/Chemistry"><li>Chemistry</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Chemistry</span></h1>
			<p>Chemistry is the scientific discipline that studies the properties, composition, structure, behavior, and transformations of matter..</p>
		</div>		
    </div>
							...
							<div class="faq-inner-div  main-topics-inner-div">
								<div class="quest-faq-div active-faq quest-topics-div" id="faq10">
									...
									<div class="faq-answer-div faq-answer-display topics-answer-div" onclick="_collapse('faq243')">
										<p>Sub-Topics  <i class="bi-chevron-down"></i> <span class="count">60</span></p> 
									...
									<div class="faq-answer-div faq-answer-display" id="faq243answer" style="display: none;">  
										<div class="topics-content-div">
											<div class="image-div">
												<img src="<?php echo $website_url?>/all-images/body-pix/pollution.jpg" alt="pollution"/>
											</div>

											<div class="text">
												<h3>Environmental Pollution</h3>
												<p>Environmental pollution refers to the introduction of harmful substances or contaminants into the natural environment, resulting in adverse effects on ecosystems, human health, and the overall quality of life....</p>
										...
										<div class="topics-content-div">
											<div class="image-div">
												<img src="<?php echo $website_url?>/all-images/body-pix/water.webp" alt="synonyms"/>
											</div>

											<div class="text">
												<h3>Water</h3>
												<p>Water is a vital and versatile substance that plays a crucial role in supporting life and shaping the Earth's ecosystems....</p>
												<a href="<?php echo $website_url ?>/#" title="Number Bases">
												<button class="topics-btn" title="Play Video">Play Video </button></a>
											</div>
										</div>															
