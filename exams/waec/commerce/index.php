...
<title> Commerce | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/commerce"><li>Commerce</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Commerce</span></h1>
			<p>Commerce is a broad field that encompasses various activities related to the buying, selling, and exchange of goods and services.</p>
		</div>		
    </div>
