...
<title> Jupeb Exam | <?php echo $thename?></title>
...
<div class="other-pages-title" data-aos="fade-down" data-aos-duration="1200">
	<div class="inner-div">
    	...
    	<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>JUPEB Exam</span></h1>		
				...
				<div class="right-div left-div subject-back-div">
					...
					<div class="subject-div main-subject-div">
						...
						<div class="main-text-div">
							...
							<hr></hr>
							<P class="text"><i class="bi-book"></i> Topics: 20 | Sub-Topics: 150</P>
							<br clear="all"/>
					...
					<div class="subject-div main-subject-div">
						...
						<div class="main-text-div">
							...
							<P class="text"><i class="bi-book"></i> Topics: 20 | Sub-Topics: 150</P>
							<br clear="all"/>
							<a href="<?php echo $website_url ?>/exams/waec/economics/" title="accounting">
							<button class="btn" title="Read More">Read More<i class="bi-arrow-right"></i></button></a>
						</div>
					</div>
					...
					<div class="subject-div main-subject-div">
						...
						<div class="main-text-div">
							...
							<P class="text"><i class="bi-book"></i> Topics: 20 | Sub-Topics: 150</P>
							<br clear="all"/>
							<a href="<?php echo $website_url ?>/exams/waec/christian-religious-knowledge/" title="christian religious knowledge">
							<button class="btn" title="Read More">Read More<i class="bi-arrow-right"></i></button></a>
						</div>
					</div>
					...
					<div class="subject-div main-subject-div">
						...
						<div class="main-text-div">
							...
							<P class="text"><i class="bi-book"></i> Topics: 20 | Sub-Topics: 150</P>
							<br clear="all"/>
							<a href="<?php echo $website_url ?>/exams/waec/islamic-religious-knowledge/" title="islamic religious knowledge">
							<button class="btn" title="Read More">Read More<i class="bi-arrow-right"></i></button></a>
						</div>
					</div>
					...
					<div class="subject-div main-subject-div">
						...
						<div class="main-text-div">
							...
							<P class="text"><i class="bi-book"></i> Topics: 20 | Sub-Topics: 150</P>
							<br clear="all"/>
							<a href="<?php echo $website_url ?>/exams/waec/literature-in-english/" title="literature in english">
							<button class="btn" title="Read More">Read More<i class="bi-arrow-right"></i></button></a>
						</div>
					</div>
