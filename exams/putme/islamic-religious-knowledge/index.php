...
<title> Islamic Religious Knowledge | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/islamic-religious-knowledge"><li>Islamic Religious Knowledge</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Islamic Religious Knowledge</span></h1>
			<p>Islamic Religious Knowledge (IRK) refers to the study of Islam, its beliefs, teachings, practices, and the broader Islamic civilization. </p>
		</div>		
    </div>
