...
<title> Contact Us | <?php echo $thename?></title>
        ...
        <div class="body-div-in contact-body-div">
            <div class="contact-div animated zoomIn">
                <div class="div-in">
                    ...
                    <div class="text">
                        <h2>MAIL US</h2> info@alwaysonlineclasses.com
                    </div>                 
                </div>
            </div>
            ...
            <div class="contact-div animated zoomIn">
                <div class="div-in">
                    ...
                    <div class="text">
                        <h2>CALL US</h2> +(234) 808 353 3750
                    </div>                  
                </div>
            </div>
            ...
            <div class="contact-div animated zoomIn">
                <div class="div-in">
                    ...
                    <div class="text">
                        <h2>LOCATION</h2> Challenge, Ibadan, Oyo State.
                    </div>                  
                </div>
            </div>
        </div>
            ...
            <div class="body-div-in">
                <div class="contact-mail-div"  data-aos="fade-in" data-aos-duration="1200">
                    ...
                    <div class="div-in right-div-in">
                        <div class="text-segment"><textarea class="text_field" id="message" placeholder="Message" rows="6"></textarea></div>
