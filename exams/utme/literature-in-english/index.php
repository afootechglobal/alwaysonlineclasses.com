...
<title> Literature In English | <?php echo $thename?></title>
	...
	<div class="inner-div">
		...
		<div class="div-in">
				<ul>
					...
					<a href="<?php echo $website_url?>/exams/waec/literature-in-english"><li>Literature In English</li></a>
				</ul>
			</div>		
		</div>
		<div class="content-div" data-aos="zoom-in" data-aos-duration="1200">
    		<h1 class="border" data-aos="fade-up" data-aos-duration="900"><span>Literature In English</span></h1>
			<p>Literature in English refers to the body of written works, including novels, plays, poetry, and essays, that are produced and written in the English language.</p>
		</div>		
    </div>
